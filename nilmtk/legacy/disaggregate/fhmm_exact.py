...
class FHMM(Disaggregator):
    ...
    def train(self, metergroup, num_states_dict={}, **load_kwargs):
        ...
        for i, meter in enumerate(metergroup.submeters().meters):
            ...
            if (
                num_states_dict.get(meter) is not None
                or num_states_dict.get(meter) is not None
            ):
            ...
            print(
                "Training model for submeter '{}' with {} states".format(
    ...
    def disaggregate_across_buildings(
        self, ds, output_datastore, list_of_buildings, **load_kwargs
    ):
        """
