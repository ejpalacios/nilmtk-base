...
class CO(Disaggregator):
    ...
    def partial_fit(
        self, train_main, train_appliances, do_preprocessing=True, **load_kwargs
    ):
    ...
    def _set_state_combinations_if_necessary(self):
        ...
        if self.state_combinations is None or self.state_combinations.shape[1] != len(
            self.model
        ):
        ...
        for test_df in mains:
            ...
            for i, model in enumerate(self.model):
                ...
                predicted_power = state_combinations[
                    indices_of_state_combinations, i
                ].flatten()
