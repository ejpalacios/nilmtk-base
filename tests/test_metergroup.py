...
class TestMeterGroup(unittest.TestCase):
    ...
    def test_wiring_graph(self):
        meter1 = ElecMeter(
            metadata={"site_meter": True}, meter_id=ElecMeterID(1, 1, "REDD")
        )
        meter2 = ElecMeter(
            metadata={"submeter_of": 1}, meter_id=ElecMeterID(2, 1, "REDD")
        )
        meter3 = ElecMeter(
            metadata={"submeter_of": 2}, meter_id=ElecMeterID(3, 1, "REDD")
        )
    ...
    def test_dual_supply(self):
        ...
        appliances = [
            {"type": "washer dryer", "instance": 1, "meters": [1, 2]},
        ...
        self.assertEqual(
            mg["washer dryer"].total_energy()["active"],
        ...
        mg = global_meter_group.from_list(
            [
                ...
                (
                    ...
                    (
                        ElecMeterID(3, 1, None),
                        ElecMeterID(4, 1, None),
